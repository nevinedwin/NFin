    ...
    return (
        <div className="relative z-10 flex flex-col items-center">
            ...
            <form className="w-full px-4 flex flex-col items-center justify-center gap-3" onSubmit={handleSubmit}>
                ...
                <Input placeholder='password' className='text-sm' value={password} onChange={e => setPassword(e.target.value)} containerClassName='w-full md:w-[300px] px-4' />
                <div className='w-full px-4 flex justify-center items-center'>
                    <button type='submit' className='bg-black mt-2 border bodred-white w-full md:w-[200px] p-2 rounded-lg text-sm'>Sign Up</button>
                </div>
            </form>
