...
import { ChevronRight, Delete, DeleteIcon, Edit, Edit2, Edit2Icon, Edit3, EditIcon, EyeIcon, EyeOffIcon, Trash } from 'lucide-react'
                ...
                <div className='w-full h-full flex justify-between items-center flex-col'>
                    <div className='w-full flex justify-between items-start'>
                        <div className='w-full flex justify-center items-start gap-2 '>
                            <AccountLogo name={account.name} className='w-5 h-5 text-xs font-extrabold' />
                    ...
                    <div className='w-full flex justify-between items-center'>
                        <div className='flex flex-col gap-2'>
                            <h2 className='text-3xl  font-medium'><span>{RUPEE_SYMBOL}</span> {showBalance ? balanceInd.toFixed(2) : '-----'}</h2>
